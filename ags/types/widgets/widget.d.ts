...
import GLib from 'node_modules/@girs/glib-2.0/glib-2.0?version=2.0';
...
export declare function register<T extends WidgetCtor>(klass: T, config?: Parameters<typeof registerGObject>[1] & {
    cssName?: string;
}): void;
export declare class Connectable<T> extends Gtk.Widget {
    hook<Self extends Connectable<T> & T, GObject extends GObject.Object>(gobject: GObject | App, callback: (self: Self, ...args: any[]) => void, signal?: string): Self;
    bind<Self extends Connectable<T> & T, Prop extends keyof Props<T>, Gobject extends GObject.Object, ObjProp extends keyof Props<Gobject>>(prop: Prop, gobject: Gobject, objProp?: ObjProp, transform?: (value: Gobject[ObjProp]) => T[Prop]): Self;
    on<Self extends Connectable<T> & T>(signal: string, callback: (self: Self, ...args: any[]) => void): Self;
    poll<Self extends Connectable<T> & T>(timeout: number, callback: (self: Self) => void): Self;
}
type WidgetCtor = new (...args: any[]) => Gtk.Widget;
declare function AgsWidget<W extends WidgetCtor, Self extends InstanceType<W>>(Widget: W, typename?: string): {
    new (...args: any[]): {
        ...
        binds: Bind[];
        properties: Property[];
        connectTo<GObject extends GObject.Object>(gobject: GObject, callback: (self: Self, ...args: any[]) => void, signal?: string): any;
        attribute: any;
        ...
        get_ancestor(widget_type: GObject.GType<unknown>): Gtk.Widget | null;
        ...
        get_template_child(widget_type: GObject.GType<unknown>, name: string | null): GObject.Object;
        ...
        list_accel_closures(): GObject.TClosure<any, any>[];
        ...
        connect(sigName: "notify::app-paintable", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::can-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::can-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::composite-child", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::double-buffered", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::events", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::expand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::focus-on-click", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::halign", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::has-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::has-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::has-tooltip", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::height-request", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::hexpand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::hexpand-set", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::is-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-bottom", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-end", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-left", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-right", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-start", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::margin-top", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::name", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::no-show-all", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::opacity", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::parent", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::receives-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::scale-factor", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::sensitive", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::style", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::tooltip-markup", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::tooltip-text", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::valign", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::vexpand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::vexpand-set", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::visible", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::width-request", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect(sigName: "notify::window", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        ...
        connect_after(sigName: "notify::app-paintable", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::can-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::can-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::composite-child", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::double-buffered", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::events", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::expand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::focus-on-click", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::halign", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::has-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::has-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::has-tooltip", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::height-request", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::hexpand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::hexpand-set", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::is-focus", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-bottom", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-end", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-left", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-right", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-start", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::margin-top", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::name", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::no-show-all", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::opacity", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::parent", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::receives-default", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::scale-factor", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::sensitive", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::style", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::tooltip-markup", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::tooltip-text", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::valign", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::vexpand", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::vexpand-set", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::visible", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::width-request", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        connect_after(sigName: "notify::window", callback: ($obj: Gtk.Widget, pspec: GObject.ParamSpec) => void): number;
        ...
        emit(sigName: "child-notify", child_property: GObject.ParamSpec, ...args: any[]): void;
        ...
        bind_property(source_property: string | null, target: GObject.Object, target_property: string | null, flags: GObject.BindingFlags): GObject.Binding;
        bind_property_full(source_property: string | null, target: GObject.Object, target_property: string | null, flags: GObject.BindingFlags, transform_to: GObject.TClosure<any, any>, transform_from: GObject.TClosure<any, any>): GObject.Binding;
        force_floating(): void;
        freeze_notify(): void;
        ...
        thaw_notify(): void;
        unref(): void;
        watch_closure(closure: GObject.TClosure<any, any>): void;
        ...
        construct_child(builder: Gtk.Builder, name: string | null): GObject.Object;
        custom_finished(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null, data: any): void;
        custom_tag_end(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null, data: any): void;
        custom_tag_start(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null): [boolean, GLib.MarkupParser, any];
        get_internal_child(builder: Gtk.Builder, childname: string | null): GObject.Object;
        parser_finished(builder: Gtk.Builder): void;
        set_buildable_property(builder: Gtk.Builder, name: string | null, value: any): void;
        vfunc_add_child(builder: Gtk.Builder, child: GObject.Object, type: string | null): void;
        vfunc_construct_child(builder: Gtk.Builder, name: string | null): GObject.Object;
        vfunc_custom_finished(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null, data: any): void;
        vfunc_custom_tag_end(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null, data: any): void;
        vfunc_custom_tag_start(builder: Gtk.Builder, child: GObject.Object | null, tagname: string | null): [boolean, GLib.MarkupParser, any];
        vfunc_get_internal_child(builder: Gtk.Builder, childname: string | null): GObject.Object;
...
declare namespace AgsWidget {
    var register: typeof import("./widget.js").register;
}
export default AgsWidget;
